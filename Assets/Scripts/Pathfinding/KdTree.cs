...
public class KdTree
{
    ...
    public int FindNearestK(Node pt, int k)
    {
        float bestSqDist = 1000000000f;
        float minSqDist = 0f;
        int bestIndex = -1;
        ...
        for (int i = 0; i < k - 1; i++)
        {
            SearchK(pt.gameObject.transform.position, ref bestSqDist, ref minSqDist, ref bestIndex);
    ...
    public int[] FindNearestsK(Node pt, int k)
    {
        float bestSqDist = 1000000000f;
        float minSqDist = 0f;
        int bestIndex = -1;
    ...
    public float FindNearestK_R(Node pt, int k)
    {
        float bestSqDist = 1000000000f;
        float minSqDist = 0f;
        int bestIndex = -1;
    ...
    public float[] FindNearestsK_R(Node pt, int k)
    {
        float bestSqDist = 1000000000f;
        float minSqDist = 0f;
        int bestIndex = -1;
